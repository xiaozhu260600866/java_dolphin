...
CREATE TABLE `t_article_class`  (
  ...
  `fid` int NULL DEFAULT 0 COMMENT '父id',
  `cover` varchar(900) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '图片',
...
CREATE TABLE `t_articles`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '新闻标题',
  `fclass` int NULL DEFAULT NULL COMMENT '父类id',
  `content` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '内容',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'remark',
  `published_at` date NULL DEFAULT NULL COMMENT '发表日期',
  `cover` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'cover',
  `deleted_at` int NULL DEFAULT 0 COMMENT '删除时间',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fclass`(`fclass`) USING BTREE
...
CREATE TABLE `t_category`  (
  ...
  `can_show` tinyint NOT NULL DEFAULT 1,
...
-- ----------------------------
INSERT INTO `t_category` VALUES (100, 1, 0, '测试', 100, NULL, '11222', 1, NULL, 0, NULL, NULL);
INSERT INTO `t_category` VALUES (102, 1, 100, '22', 100, NULL, '33', 1, NULL, 1622444630, '2021-05-31 15:03:35', '2021-05-31 15:03:35');
...
CREATE TABLE `t_menus`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `url` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '后台url',
...
CREATE TABLE `t_order`  (
  ...
  `weight` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '重量',
  `goods_position` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品位置',
  ...
  `take_date` datetime NULL DEFAULT NULL COMMENT '取货日期',
  `createor` int NULL DEFAULT NULL COMMENT '新建者userId',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `createor`(`createor`) USING BTREE,
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (67, 0, '2021-05-30 13:01:34', '2021-05-31 09:47:15', NULL, 16, 2, '13326805391', NULL, '7544937923567611001', 1, '洗衣液', '3.04', '111', 5.00, 3, 3, '2021-05-31 17:47:15', '2021-05-30 21:01:34', 1);
...
CREATE TABLE `t_poster`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'remark',
  `is_index` tinyint NOT NULL DEFAULT 0 COMMENT '是否首页',
  `deleted_at` int NULL DEFAULT 0 COMMENT '删除时间',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 261 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_roles`  (
  ...
  `menu_str` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色菜单',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `deleted_at` int NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_shops`  (
  ...
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '联系人电话',
  `company_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '门店名称',
  `created_at` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `deleted_at` int NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_site_config`  (
  ...
  `deleted_at` int NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9313 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_site_config
-- ----------------------------
INSERT INTO `t_site_config` VALUES (9315, 'web_logo', 'http://localhost:8089/static/images/product/03deb86f-f3f6-4baf-a9cd-f3558cf0c1ef.jpg', NULL, NULL, NULL, '2021-05-31 14:51:29', 0);
INSERT INTO `t_site_config` VALUES (9316, 'web_content', '11111222266667788', NULL, NULL, NULL, '2021-05-31 14:51:29', 0);
INSERT INTO `t_site_config` VALUES (9317, 'wechat_logo', 'http://localhost:8089/static/images/product/3fb456db-acec-43a8-88e7-ce19d016f30a.jpg', NULL, NULL, '2021-05-31 14:51:18', '2021-05-31 14:51:29', 0);
INSERT INTO `t_site_config` VALUES (9318, 'news_cover', 'http://localhost:8089/static/images/product/4bee3493-cf98-48c3-ac4e-715708622f84.jpg', NULL, NULL, '2021-05-31 14:51:29', '2021-05-31 14:51:29', 0);
...
CREATE TABLE `t_user_infos`  (
  ...
  `phone` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '管理员手机号码',
...
INSERT INTO `t_user_infos` VALUES (12, 12, 'xiaozhu', '13328805395', NULL, NULL, NULL, NULL, '2021-05-30 12:05:38', '2021-05-30 12:30:07', 0);
...
CREATE TABLE `t_user_roles`  (
  ...
  INDEX `adminId`(`user_id`) USING BTREE
...
CREATE TABLE `t_users`  (
  ...
  `role` tinyint NULL DEFAULT 1 COMMENT '用户角色',
...
INSERT INTO `t_users` VALUES (12, 0, '13328805395', '$2a$10$Tx6AweQbu22Sl37MfxzKfu7pB7YXGAztHum.b.PpKLWg5mSxZBwba', 3, 0.00, 5, '2021-05-30 12:05:38', '2021-05-30 12:30:07', 0, 19);
